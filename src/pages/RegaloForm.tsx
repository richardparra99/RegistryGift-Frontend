...
const RegaloForm = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!name.trim() || !description || quantity <= 0) {
    ...
    try {
      ...
      navigate(URLS.APP.DETAIL.replace(":id", res.event.id));
      ...
      <Container>
        <div className="max-w-md mx-auto mt-10 p-6 bg-white rounded shadow-md">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mb-4">
              <label className="block font-semibold mb-1">Enlace de Referencia (opcional)</label>
              <input
                type="url"
                value={referenceLink}
            ...
            <div className="mb-4">
              <label className="block font-semibold mb-1">Prioridad (opcional)</label>
              <select
                value={priority}
